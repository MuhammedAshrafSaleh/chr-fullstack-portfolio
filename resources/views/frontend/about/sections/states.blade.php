...
<section class="stats" id="stats-section">
    <div class="stats__container">
        ...
        <div class="stats__content">
            <h2 class="stats__title" data-aos="fade-right" data-aos-duration="700" data-aos-offset="100" data-aos-delay="0">
                {{ $aboutHeading->about_numbers_title }}
            </h2>
            <p class="stats__description" data-aos="fade-right" data-aos-duration="700" data-aos-offset="100"
                data-aos-delay="150">
        ...
        <div class="stats__list">
            @foreach ($aboutNumbers as $item)
                <div class="stats__card" data-aos="fade-up" data-aos-duration="700" data-aos-offset="100"
