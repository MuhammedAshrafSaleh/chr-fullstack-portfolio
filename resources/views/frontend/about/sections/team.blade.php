...
<section class="team">
    <div class="team__container">
        ...
        <div class="team__header">
            <h2 class="team__title" data-aos="fade-up" data-aos-duration="700" data-aos-offset="100" data-aos-delay="0">
                {{ $aboutHeading->team_title }}
            </h2>
            <p class="team__subtitle" data-aos="fade-up" data-aos-duration="700" data-aos-offset="100"
                data-aos-delay="150">
                {{ $aboutHeading->team_subtitle }}
            </p>

            <div class="team__navigation" data-aos="fade-up" data-aos-duration="700" data-aos-offset="100"
                data-aos-delay="300">
        ...
        {{-- <div class="team__slider swiper" data-aos="fade-up" data-aos-duration="700" data-aos-offset="100"
            data-aos-delay="400">
