...
<section class="features">
    <div class="features__container">
        ...
        <header class="features__header">
            <h2 class="features__title" data-aos="fade-up" data-aos-duration="700" data-aos-offset="5" data-aos-delay="0">
                {{ $aboutHeading->features_title }}
            </h2>
            <p class="features__subtitle" data-aos="fade-up" data-aos-duration="700" data-aos-offset="5"
                data-aos-delay="150">
        ...
        <div class="features__grid">
            @foreach ($features as $feature)
                <div class="features__item" data-aos="fade-up" data-aos-duration="700" data-aos-offset="5"
