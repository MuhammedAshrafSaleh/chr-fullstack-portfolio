    ...
    <div class="project-showcase">
        ...
        <nav class="project-nav">
            <ul class="project-nav__list">
                ...
                <li class="project-nav__item"><a href="#project-3" class="project-nav__link"
                        title="The Grand Marquee"></a></li>
                ...
                <li class="project-nav__item"><a href="#project-7" class="project-nav__link"
                        title="The Corporate Axis"></a></li>
