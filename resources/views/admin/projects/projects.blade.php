                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input type="text" name="subtitle[en]" class="form-control"
                                       value="{{ old('subtitle.en', $project->getTranslation('subtitle', 'en')) }}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input type="text" name="subtitle[ar]" class="form-control" dir="rtl"
                                       value="{{ old('subtitle.ar', $project->getTranslation('subtitle', 'ar')) }}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input type="number" name="longitude" class="form-control"
                                       step="any" value="{{ old('longitude', $project->longitude) }}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input type="number" name="latitude" class="form-control"
                                       step="any" value="{{ old('latitude', $project->latitude) }}" required>
                            </div>
                        </div>
                            ...
                            <div class="modal-body" style="overflow-y: auto; flex: 1;">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" name="title[en]" class="form-control"
                                               value="{{ old('title.en') }}"
                                               placeholder="e.g. Green Tower Complex" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" name="title[ar]" class="form-control" dir="rtl"
                                               value="{{ old('title.ar') }}"
                                               placeholder="مثال: برج الخضراء" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" name="subtitle[en]" class="form-control"
                                               ...
                                               placeholder="e.g. Residential skyscraper in Cairo" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" name="subtitle[ar]" class="form-control" dir="rtl"
                                               ...
                                               placeholder="مثال: ناطحة سحاب سكنية في القاهرة" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="number" name="longitude" class="form-control"
                                               step="any" value="{{ old('longitude') }}"
                                               placeholder="e.g. 31.23456789" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="number" name="latitude" class="form-control"
                                               ...
                                               placeholder="e.g. 30.12345678" required>
                                    </div>
                                </div>
